...
def load_data_and_train():
    try:
        ...
        m_smote = RandomForestClassifier(n_estimators=300, max_depth=12, random_state=42, n_jobs=1)
        m_smote.fit(X_train_res, y_train_res)

        m_balanced = BalancedRandomForestClassifier(n_estimators=300, max_depth=10, sampling_strategy='all', random_state=42, n_jobs=1)
