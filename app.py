...
try:
    ...
    for i, col in enumerate(selected_features):
        ...
        # LOGIKA PERBAIKAN: Gunakan Selectbox untuk kategori, Slider HANYA untuk kecepatan
        if col == 'kecepatan':
            ...
            # Untuk kolom kategori lainnya, gunakan dropdown tulisan
